...
{
	HAL_I2C_Mem_Write(&hi2c4, deviceAddr, reg, I2C_MEMADD_SIZE_8BIT, &value, 1, 100);
}
...
//hardware and software init
  HAL_GPIO_WritePin(OV_PWDN_GPIO_Port, OV_PWDN_Pin, GPIO_PIN_RESET);  //power on
  osDelay(10);
  HAL_GPIO_WritePin(OV_RST_GPIO_Port, OV_RST_Pin, GPIO_PIN_RESET);  //hardware reset
  osDelay(10);
