...
static const sUiPanel_t main_menu_panel = {
    ...
    .children = (sUiElementType_t[]) {
    	LABEL("Menu",  0, 0, eFont11x18, eHorizontalAlignmentCenter),
    	NAV_BUTTON("Video", 0, 0, eFont11x18, eHorizontalAlignmentCenter, ePanelVideoSettings),
		NAV_BUTTON("Edge", 0, 0, eFont11x18, eHorizontalAlignmentCenter, ePanelEdgeSettings),
		NAV_BUTTON("Thermal", 0, 0, eFont11x18, eHorizontalAlignmentCenter, ePanelThermalSettings),
    },
    .children_amount = 4,
	.selectable = 3,
...
static const sUiPanel_t param_change_default_panel = {
	...
	.spacing_y = 40,
    .children = (sUiElementType_t[]) {
		LABEL(current_param_name_text, 0, 0, eFont11x18, eHorizontalAlignmentCenter),
		LABEL(current_param_value_text, 0, 0, eFont11x18, eHorizontalAlignmentCenter),
    },
    .children_amount = 2,
	.selectable = 0,
...
static const sUiPanel_t constant_menu = {
	...
	.spacing_y = 40,
	.children = (sUiElementType_t[]) {
		LABEL(time_text, 128, 290, eFont11x18, eHorizontalAlignmentCenter),
		LABEL("Group A", 425, 1, eFont11x18, eHorizontalAlignmentCenter),
		LABEL(battery_icon_text, 35, 290, eFont11x18, eHorizontalAlignmentCenter),
	},
	.children_amount = 3,
	.selectable = 0
};
