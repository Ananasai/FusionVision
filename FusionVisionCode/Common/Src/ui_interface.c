...
static const sUiPanel_t main_menu_panel = {
	.x = 50,
	.y = 270,
	.vert_align = eAlignmentMiddle,
	.hor_align = eAlignmentRight,
	.spacing_y = 40,
    .children = (sUiElementType_t[]) {
    	LABEL("Menu",  0, 0, eFont11x18, eTextAlignmentCenter),
    	NAV_BUTTON("Video", 0, 0, eFont11x18, eTextAlignmentCenter, ePanelVideoSettings),
		NAV_BUTTON("Edge", 0, 0, eFont11x18, eTextAlignmentCenter, ePanelEdgeSettings),
		NAV_BUTTON("Thermal", 0, 0, eFont11x18, eTextAlignmentCenter, ePanelThermalSettings),
    },
    .children_amount = 4,
	.selectable = 3,
...
static const sUiPanel_t video_settings_panel = {
	...
	.spacing_y = 40,
	.children = (sUiElementType_t[]) {
		LABEL("Video",  0, 0, eFont11x18, eTextAlignmentCenter), //TODO: add mutiple line text
		LABEL("settings",  0, 0, eFont11x18, eTextAlignmentCenter),
		PARAM_CHANGE_BUTTON("Threshold", 0, 0, eFont11x18, eTextAlignmentCenter, eSharedParamEdgeThreshold),
		PARAM_CHANGE_BUTTON("State", 0, 0, eFont11x18, eTextAlignmentCenter, eSharedParamScreenState),
		PARAM_CHANGE_BUTTON("Optim", 0, 0, eFont11x18, eTextAlignmentCenter, eSharedParamScreenOptim),
		NAV_BUTTON("Back", 0, 0, eFont11x18, eTextAlignmentCenter, ePanelMainMenu),
	},
	.children_amount = 6,
	.selectable = 4,
	.btn_callback = &UI_NavigationalButtonCallback
...
static const sUiPanel_t edge_settings_panel = {
	...
	.spacing_y = 40,
	.children = (sUiElementType_t[]) {
		LABEL("Edge",  0, 0, eFont11x18, eTextAlignmentCenter),
		LABEL("settings",  0, 0, eFont11x18, eTextAlignmentCenter),
		PARAM_CHANGE_BUTTON("Threshold", 0, 0, eFont11x18, eTextAlignmentCenter, eSharedParamEdgeThreshold),
		NAV_BUTTON("Back", 0, 0, eFont11x18, eTextAlignmentCenter, ePanelMainMenu),
	},
...
static const sUiPanel_t thermal_settings_panel = {
	...
	.spacing_y = 40,
	.children = (sUiElementType_t[]) {
		LABEL("Thermal",  0, 0, eFont11x18, eTextAlignmentCenter),
		LABEL("settings",  0, 0, eFont11x18, eTextAlignmentCenter),
		LABEL("WIP",  0, 0, eFont11x18, eTextAlignmentCenter),
		LABEL("WIP",  0, 0, eFont11x18, eTextAlignmentCenter),
		NAV_BUTTON("Back", 0, 0, eFont11x18, eTextAlignmentCenter, ePanelMainMenu),
	},
	.children_amount = 5,
...
static const sUiPanel_t param_change_default_panel = {
	...
	.spacing_y = 40,
    .children = (sUiElementType_t[]) {
		LABEL(current_param_name_text, 0, 0, eFont11x18, eTextAlignmentCenter),
		LABEL(current_param_value_text, 0, 0, eFont11x18, eTextAlignmentCenter),
    },
    .children_amount = 2,
	.selectable = 0,
...
static const sUiPanel_t constant_menu = {
	...
	.spacing_y = 40,
	.children = (sUiElementType_t[]) {
		LABEL(time_text, 128, 290, eFont11x18, eTextAlignmentCenter),
		LABEL("Group A", 425, 1, eFont11x18, eTextAlignmentCenter),
		LABEL(battery_icon_text, 35, 290, eFont11x18, eTextAlignmentCenter),
	},
	.children_amount = 3,
	.selectable = 0
};
